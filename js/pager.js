     ...
     */
{
     ...
     * @private
     */
    _getDisableFormat : function(text){
        var me = this;
        return baidu.string.format('<span class="#{0}">#{1}</span>',
            me.getClass('disable'),
            text
        );
    },
    ...
    _genBody: function (){
        ...
        spec.previous = pageMap.previous < begin ? me._getDisableFormat(me.specialLabelMap['previous']) : spec.previous;
        spec.next = pageMap.next >= end ? me._getDisableFormat(me.specialLabelMap['next']) : spec.next;
